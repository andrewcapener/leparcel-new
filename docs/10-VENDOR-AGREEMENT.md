...
the person who applied.** You may sell the goods described in your accepted
application: goods you make yourself, goods made under your direct supervision in
small batches, and, where we accepted you on that basis, goods you sourced or
curated and described to us honestly. What is not allowed is selling someone
else's work as your own. (Rewritten September 2026 against the application form
and the FAQ. See the note under §5.3.)
...
**5.3 Not permitted:** goods presented as your own that you did not make, or did
not source and describe the way your application said; mass-produced or imported
merchandise passed off as handmade; multi-level-marketing and direct-sales lines,
unless we accepted you for a product you make yourself using those materials and
your shop name does not carry the company's name; and ⟨DECISION⟩ **artwork or
product imagery generated by AI.** The AI ban
...
**7.2 (Option A, as originally drafted, and NOT what is published.)** You must
maintain commercial general liability insurance of not less than **$1,000,000 per
occurrence and $2,000,000 aggregate**, naming **Mermade Market and the Show venue
as additional insureds**, in force for the full Show period including load-in and
load-out. You must upload the certificate before load-in.

**7.2 as published**, until the broker call settles it: Mermade carries its own
event policy, which covers Mermade and not you. We recommend you carry your own
commercial general liability insurance. If the venue or your acceptance requires
a certificate for your Show, we will tell you and you send it before load-in,
naming Mermade Market and the Show venue as additional insureds.
...
**A2.1** You send your inventory list with prices **at least two weeks before the
Show** (which is what the live indoor page already requires) and deliver the goods
...
**A2.5 Deductions (published, and the operative version of A2.3).** The only
amounts taken off your settlement are the commission and anything Mermade supplied
on your behalf, charged at cost and itemised on the statement with its reason. An
item that arrives untagged is tagged by a member of staff and not charged for.
...
**A6.2** Within **`POLICY.payoutDays` days** of the Show closing, currently seven,
Mermade will give you a written settlement statement showing units sold, retail
price, sales tax collected, commission retained, any deductions with their reason,
and the net amount due, and will pay the net in the same window. (Was 14 days for
the statement and 30 for the money. See A6.3.)

**A6.2a** A statement is never deleted. A correction is issued as a new statement
that supersedes the old one, and both stay on the record. (Published, and it is
CLAUDE.md rule 3 written down for the maker.)
...
**B2.1 ⟨corrected September 2026⟩** Your space is the tent Mermade puts up for
you, in the size stated on your acceptance. **The standard Mermade tent is 6.5' ×
6.5' × 7.5' tall, not 10' × 10'**; a limited number of 10 × 10s are offered as a
priced add-on. Dimensions live on the outdoor maker page so there is one copy of
them. Everything you bring stays inside your space and out of the aisles: tables,
racks, signage, stock, your chair. Nothing goes in front of the tent.
...
**B5.2** There is power at each space. Bring your own extension cord with your
shop name on it.

## B6. Weather outside

*Added September 2026. Not new policy: this is the outdoor maker page's own rule,
written down. See the note at §4.4.*

**B6.1** If Mermade cancels an outdoor day for weather, your fee for that day
carries to the next Show, on the same day you booked, at no extra charge.

**B6.2** If you would rather not take that day at the next Show, tell us in
writing within 7 days of the cancellation and we reimburse **30% of that day's
fee**. We keep the rest against the advertising already spent on your shop.

**B6.3** If the day goes ahead in poor weather and you choose not to come, there
is no refund and no day at a later Show.

**B6.4** If you cancel a day yourself, the fee is not refunded, but we will carry
it once to the next Show at no extra charge if you ask during that Show's
application window. Asking is on you; nothing is carried forward automatically.
...
Updated September 2026, when the agreement was published at `/agreement` and every
clause was compared against the seed, the Show record and the market's own live
pages. Four of these moved, and two moved because the live copy already answered
them and nobody had looked.

| # | Decision | Status |
|---|---|---|
| 1 | **Application fee** | ✅ **None.** Confirmed against the live page. §2.2 |
| 2 | **Cancellation** | 🟡 **Non-refundable in cash, carried forward once on request.** The transfer right I offered as an option is already published on the outdoor page. Drafted at §B6.4. **Decide whether it applies inside too.** §3.2, §3.3 |
| 3 | **Insurance** | 🔴 **Option B pending one broker call, and the form now contradicts the draft.** `/apply` says "recommended, not required"; drafted §7.2 required $1M/$2M and a certificate. The published §7 states today's position and leaves the door open. §7.1 |
| 4 | **Applications open** | ✅ **Monday 7 September 2026.** Close drafted as Friday 18 September and seeded as such. Still unconfirmed |
| 5 | **Payment window** | ✅ **Off the Show record, currently 48 hours.** The 36 in this document was the last hardcoded copy and was stale. §2.3 |
| 6 | **Outdoor weather reimbursement** | 🟡 **Already defined, on your own outdoor page.** Cancelled day rolls to the next show, same day; decline it and 30% of that day's fee comes back. Drafted at §B6. The only open piece is *when* you announce a cancellation. §4.4 |
| 7 | **$100 label deduction** | 🔴 **Drop it, and now you have to choose, because both versions are live.** `/makers/indoor` publishes it under "Rules that cost money"; the agreement's §A2.5 says deductions are commission plus cost only. §A2.3 |
| 8 | **$20 jewelry-box deduction** | 🔴 Same fork as 7. Keep it and it belongs in §A2.5 at cost, renamed "packaging supplied", or drop it with the label penalty. §A2.3 |
| 8b | **$100 late-arrival charge** | 🔴 **Undrafted and unmodelled.** Published on `/makers/indoor`, absent from the agreement and from the schema. Draft it or drop it. §A2 |
| 9 | **Markdown authority** | ⚪ **Opt-in only, and there is no opt-in field, so for Fall 2026 the answer is no markdowns without written authorisation.** §A3.2 |
| 10 | **Shrinkage credit** | ⚪ **Full net**, retail less commission. §A8.4 |
| 11 | **Payout timing** | 🟡 **7 days, not 30.** Your own page promises "within 1 week"; a contract must not be slower than the page the maker read. Safe only because §A7.1 absorbs post-settlement returns. Confirm it matches what actually happens. §A6.3 |
| 12 | **Shared booths** | 🟡 **Juried as a pair**, and the form cannot yet record two signatures. Take the second maker's name and email, or countersign by email before load-in. §13.2 |
| 13 | **Tent weights** | 🔴 **Confirm with the Community House.** The published clause points at the load-in instructions so the number lives in one place. And §B2.1's "10' x 10'" was wrong: the tents are 6.5 feet square. §B3.1 |
| 14 | **Returns after settlement** | ⚪ **Mermade absorbs them**, which is also what makes the 7-day payout safe. §A7.1 |
| 15 | **Postponement: credit or cash** | 🔴 **Yours, and unanswered by anything in the repo.** Roughly $30-40k of booth fees is what the choice is about. Drafted as a credit with a refund at our option. §4.2 |
| 16 | **Handmade, curated and resold** | 🔴 **New, and a genuine contradiction.** The draft banned resale; the application, the FAQ and the Vintage category all invite it. Published §5.1 reads on misrepresentation instead. Confirm which rule is real. §5.3 |
| 17 | **Cleanup charge outside** | 🔴 Name a figure or keep absorbing it. Nothing is drafted. §B4.2 |
| 18 | **Mediation or small-claims step** | 🔴 Not drafted, on purpose. A hurdle in front of a maker's remedy is a decision. §14.2 |

🔴 needs an answer from you · 🟡 one call or email · ⚪ answered — overrule if you disagree · ✅ settled

---

## Where the agreement and the code disagree

Found by reading every number in this document against `src/db/seed.ts`, the Show
record, `src/app/actions.ts` and the market's own pages in `src/lib/page-html.ts`.
Ordered by how much it would cost to be wrong. The published page resolves each
one the way the "published as" column says, and none of those resolutions is a
new policy.

| # | The disagreement | The two sides | Published as |
|---|---|---|---|
| 1 | **Payment window** | Agreement said 36 hours. `shows.payment_window_hours` is **48**, moved by Drew | Token off the Show record. The prose no longer carries a number |
| 2 | **Insurance** | §7.2 required $1M/$2M and a certificate before load-in. `/apply` says "recommended, not required" | Recommended, plus a hook: required if the venue or your acceptance says so |
| 3 | **Handmade vs curated** | §5.1 and §5.3 banned resale. The form offers `curate_resell`, the FAQ welcomes wholesale-curated shops, `Vintage` is a seeded category | Sell what your application described. Misrepresentation is the breach |
| 4 | **Payout timing** | §A6.3 said 30 days. `/makers/indoor` says "within 1 week". `06-OPEN-QUESTIONS.md` §9 recommends 10 business days | 7 days, statement and payment together |
| 5 | **Deductions** | §A2.3 drops the $100 label penalty. `/makers/indoor` publishes $100 late, $100 labels, $20 jewelry bags | Commission plus anything supplied at cost, itemised. No penalties |
| 6 | **Outdoor tent size** | §B2.1 said 10' x 10'. The outdoor page says 6.5' x 6.5' x 7.5' tall, with a few 10 x 10s as a **paid add-on** | The tent we put up, in the size on your acceptance. Dimensions on the outdoor page |
| 7 | **Cancellation** | §3.2/§3.3 said non-refundable and non-transferable. The outdoor page promises a carry-forward to the next show on request | Non-refundable, carried once outside on request, at §B6.4 |
| 8 | **Weather** | §4.4 called the 30% undefined. The outdoor page defines the trigger, the base and who it is paid to | §B6, in the market's own shape |
| 9 | **Signature record** | §1.3 promised name, time **and IP address**. The code stores name, terms version and timestamp | Name, version, date and time |
| 10 | **Inventory list** | §A2.1 took the list at load-in. `/makers/indoor` requires it **two weeks before** | List two weeks before, goods at load-in, counted in against the list |
| 11 | **Loss of goods inside** | §A8.2 accepts responsibility for our own negligence. Both maker pages say "we cannot be held responsible" | §A8.2 as drafted. **The maker pages now contradict the contract and need editing** |
| 12 | **MLM** | §5.3 banned them flat. The FAQ and the outdoor page carve out an MLM-derived product the maker actually makes | The carve-out, with the shop-name condition |
| 13 | **Outdoor hours** | The fee schedule in this document says Friday 9am-6pm. The Show record says Friday 5-9pm, and the outdoor page's schedule block still says 9am | Hours token off the Show record |
| 14 | **Show dates** | `CLAUDE.md` says the show is November 12-15. The seed runs 13-15 with load-in on the 12th | The Show record, rendered |
| 15 | **Shared booths** | §13.2 has both makers sign. One application, one email, one `signed_name` | As drafted, with the gap flagged. The form has to change |
| 16 | **Minors** | Nothing in the draft. A JR space is for makers 14 and under and there is no guardian field | Guardian applies, signs, and is paid. §A10.3 |

Two of these are not the agreement's problem to fix and need an edit somewhere I
did not touch: **the liability sentences on `/makers/indoor` and
`/makers/outdoor`** ("we cannot be held responsible"), which now contradict
§A8.2, and **the outdoor page's 9am schedule block**, which contradicts the Show
record. Both live in `src/lib/page-html.ts`.
