...
const PRODUCTS: Array<{ category: Category; blurb: string; low: number; high: number }> = [
  ...
  { category: 'Apparel', low: 4600, high: 29000,
    blurb: 'Naturally dyed linen in indigo, madder and onion skin, cut and sewn into everyday pieces meant to be worn until they go soft.' },
  ...
  { category: 'Jewelry', low: 3200, high: 48000,
    blurb: 'Hand-forged brass and sterling, made with a torch and a bench block. No casting and no outsourcing, so each piece is worked one at a time.' },
...
async function main() {
  ...
  const spaces = [
    ...
    { code: 'IN-3x4',   track: 'indoor' as const,  label: '3x4',   priceCents: 26_000, capacity: 10, dimensions: '4ft wide, 3ft deep', description: 'Not used for any sort of apparel. You have to be creative with vertical space.' },
    { code: 'IN-3x6',   track: 'indoor' as const,  label: '3x6',   priceCents: 28_000, capacity: 13, dimensions: '6ft wide, 3ft deep', description: 'Our best seller, and it works for all sorts of goods.' },
    { code: 'IN-3x8',   track: 'indoor' as const,  label: '3x8',   priceCents: 34_000, capacity:  8, dimensions: '8ft wide, 3ft deep', description: 'Great for apparel or artwork, and a lot of space. On a corner we usually run four feet on one side and four on the other, so there are plenty of ways to use it.' },
    { code: 'IN-3x12',  track: 'indoor' as const,  label: '3x12',  priceCents: 45_000, capacity:  2, dimensions: '12ft wide, 3ft deep', description: 'Given out sparingly, and really for apparel only.' },
