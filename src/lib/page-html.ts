...
export const indoorSections: PageSection[] = [
  ...
  },
  {
    ...
    html: `<p>We will create a unique Mermade ID for each our of makers and they will be issued to you when you’re accepted to the market. Then 2-3 weeks before the show, we send you detailed info on how to label your products and how to make sure that each product you sell, is in fact, labeled correctly so we can enter it into the Mermade register.</p><p>For example our unique ID will look like this, followed by the price: MM34 $15<br/><br/>Please have every single product clearly labeled with your Mermade ID and the price. Make sure they are large enough to be seen quickly at the registers.&nbsp;<strong>However, do NOT have your tag larger than the item you're selling. </strong><br/><br/>Please affix tags neatly and professionally, so they stay put and we can be sure to give you credit for every single sale. If your price isn’t on tag, and there is a line of shoppers, we may have to guess what the price is based on your other items.</p><p>IF YOU DO NOT LABEL YOUR PRODUCTS CORRECTLY OR <strong>AT ALL</strong>, WE WILL TAKE OUT $100 FROM YOUR FINAL PAYMENT.</p>`,
  },
  {
    id: 'treats',
    q: 'Treats on a shelf',
    html: `<p>If you choose this section as your shop space, know this: you will be given 5 shelves (top to bottom, 2 feet wide, about 6 feet tall) that sits near our registers. It’s a great option for people to grab as they walk in, that’s not a super high price point, and also for them to think about as they shop &amp; they can grab more for teacher/hostess gifts, last minute birthday gifts or just for their drive home to snack on. Or a treat for their babysitter that had their kids all day while they got to shop solo!</p><p>If you price it over $12, we do notice a drop in sale quantities, but we can discuss this after you are accepted.</p><p>You share the shelf with 2 to 3 other “treats on a shelf” makers. We look at it like a collective grouping.</p><p>If you live far and cannot restock each day with your goods, feel free to leave all of your inventory with us on {{loadInDay}}, with instructions on how to keep the items fresh. We have a large fridge in our restock room we are happy to use for this. You are also welcome to restock each day yourself. We will note all of this as the show gets closer.</p><p>We will not have two makers selling the same item (only one cookie maker, one toffee maker, and so on) to keep it exciting and the sales good for everyone.</p><p>You will be required to order a <a href="http://www.ocfoodinfo.com/tff" target="_blank" rel="noopener">TFF permit</a>. You can apply without having it, but we highly suggest you start working on it as soon as possible. If you need help, call the OC Health Agency today. They are super helpful.</p>`,
  },
  {
    id: 'jewelry',
    q: 'Jewelry makers',
...
export const applyFaq: Array<{ q: string; a: string }> = [
  ...
  {
    "q": "If I'm a food maker do I need a permit",
  ...
  {
    "q": "Inside makers - when do I get paid",
