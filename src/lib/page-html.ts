...
export const indoorSections: PageSection[] = [
  ...
  },
  {
    ...
    html: `<p>We love, love, love including junior makers in our market! They are the perfect addition to our space. Often these kids have been shoppers with their parents at past markets &amp; leave inspired and empowered to start making product, just to sell at Mermade. We are only able to do this option if we get at least 2 approved makers that have a good-fitting product. You are allotted 2 feet WIDE of store space and 3 feet deep. We give you the space shelf so all you need to bring is your finished products!</p><p>Also note, if you have a company that’s been up &amp; running for a while, but you are under 18 yrs, this option doesn’t apply to you. Even if your parent applies for you &amp; if we can see your product is already off to a great start, then you can get your own space. The junior space is very small &amp; not meant for a larger business. If it’s money you are nervous on spending (under 18, looking at you)- then perhaps look into the “boutique” section. </p>`,
  },
  {
    id: 'advertising',
