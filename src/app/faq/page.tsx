  ...
  const merchants: Tab[] = [
    {
      ...
      a: <p>Our inside space (all 3 days) only allows {show.indoorCapacity}.. Outside, {show.outdoorCapacity} each day. If you create a fresh product we haven&rsquo;t seen before, or put a new spin to something we have seen, chances are high you&rsquo;ll get in. You have great branding &amp; a vision for your online brand? Yes.. can&rsquo;t wait to have you.</p>,
    },
    {
      q: 'How are merchants selected?',
      a: <p>The moment applications open &amp; start coming in, we get the wheels turning. We are emailing applicants, requesting new content or a photographs we can&rsquo;t find online... and we have them categorized. New Makers/Repeat Makers/Need improvement makers. We choose the freshest, best branded shops that come in. We also only select 1-3 makers in each category.</p>,
    },
    {
      q: 'Do you accept painters / Artists?',
      a: <p>Depends on the art. If your art is being sold in galleries, let&rsquo;s just tell you right now&hellip; our show is NOT a gallery. While some of our customers love taking home a special piece.. if you&rsquo;re expecting every customer to be ready to throw down some money for an amazing original, it might not happen. If you MUST come to Mermade for networking and some ad space, then great, we can provide that, but please apply for the outside section and keep your prices realistic. If you want to be an &ldquo;inside maker&rdquo;, you must make your work under $100, even maybe under $50. Prints are fine but don&rsquo;t sell like they do outside.</p>,
    },
    {
      q: 'Does my product need to be handmade?',
      a: <p>For the most part, yes. We do not allow for &ldquo;MLM&rdquo; companies. If you have a curated shop where you wholesale items from a factory (like clothing) or wholesale from other shops, it&rsquo;s all good. We understand a lot of shops do that and it makes sense that not everyone can handmake everything. If we think you have a vision &amp; are working hard to sell that product, let&rsquo;s do this.</p>,
    },
    {
      q: "If I'm not accepted this time, can I apply again?",
      a: <p>Yes! We don&rsquo;t <em>want</em> to accept our old vendors a million times. We gotta keep it FRESH. If you weren&rsquo;t accepted, you were most likely given a reason why so that you can fix it by the next time! That&rsquo;s the great thing about being a creator. Creating &amp; changing often is a beautiful work of art! Or you weren&rsquo;t accepted because there simply was too many jewelry makers and we just can&rsquo;t have you all! No hard feelings!</p>,
    },
    {
    ...
    <>
      ...
      <main id="content" role="main">
        <div className="container cf">
          ...
          >
            <p>Didn&rsquo;t answer your question - reach out</p>
          </RichText>
        </div>
      </main>
